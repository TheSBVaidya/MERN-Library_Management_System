...
const Sidebar = ({ currentView, setView, onLogout }) => {
  const navItems = [
    ...
    { id: "addBook", icon: BookIcon, label: "Add Book" },
    { id: "manageBook", icon: BookIcon, label: "Manage Books" },
    { id: "payments", icon: PaymentsIcon, label: "Payment" },
  ...
  return (
    ...
    >
      ...
      >
        <span className="fs-4">librarian Panel</span>
      </a>
      <hr />
